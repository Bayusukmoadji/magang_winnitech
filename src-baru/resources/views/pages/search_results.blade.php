{{-- resources/views/pages/search_results.blade.php (Versi Final Sempurna) --}}
...
<head>
    ...
    <title>Hasil Pencarian untuk: {{ $searchQuery }}</title>
...
<body>
    ...
    {{-- Navbar Lengkap dengan Tombol Search yang sudah diberi class --}}
    ...
    <section class="container-lg my-5 pt-5 text-white">
        <h1 class="mb-4 pt-4 search-results-title">Hasil Pencarian untuk: <span class="text-info">"{{ $searchQuery }}"</span></h1>
        ...
        @else
            <div class="col-12">
                <p class="text-center fs-4 mt-5 no-results-message">Tidak ada hasil yang ditemukan untuk pencarian Anda.</p>
            </div>
        @endif

        <div class="d-flex justify-content-center mt-4 pt-2 pb-4">
            ...
            <div class="row justify-content-center align-items-start gy-4 gx-md-5">
                ...
                <div class="col-md-4 text-center">
                    ...
                    <div class="social-icons-group">
                        <div class="social-icons-row mb-2"><a href="#"><i class="bi bi-twitter-x fs-4"></i></a><a href="#"><i class="bi bi-facebook fs-4"></i></a><a href="#"><i class="bi bi-telegram fs-4"></i></a><a href="#"><i class="bi bi-instagram fs-4"></i></a></div>
                        <div class="social-icons-row"><a href="#"><i class="bi bi-tiktok fs-4"></i></a><a href="#"><i class="bi bi-youtube fs-4"></i></a><a href="#"><i class="bi bi-whatsapp fs-4"></i></a><a href="#"><i class="bi bi-line fs-4"></i></a></div>
                    </div>
                </div>
                <div class="col-md-3">
